...
class WeightedDirectedGraph
{
     protected:
          ...
          void InitalizeSingleSourceForGreedyMethod(int s, int* parentArr, int* residualCapacityArr, bool* visitedArr);
          void Relax(int u, int v, int* parentArr, int* residualCapacityArr, bool* visitedArr, MaxPriorityQueue& maxQueue);
          void InitalizeSingleSourceForBFS(int s, int* parentArr, bool* visitedArr);
